...
# **CHANGED lamda FROM 3.3 (0.2 -> 2.0)**
...
xR, V0, a, lamda = 25.0, 20.0, 2.0, 2.0  # variables to test convergence (xR=right limit, V0=well depth, a=well width, lamda=screening strength)
