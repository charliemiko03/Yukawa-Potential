...
xR, V0, a, lamda = 25.0, 20.0, 1.0, 0.2  # variables to test convergence (xR=right limit, V0=well depth, a=well width, lamda=screening strength)
...
plt.ylim(EL[0][0]-.3, 16), plt.xticks(range(Lmax))
